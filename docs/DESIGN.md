...
- **Every verse carries a tip; a saved verse carries the whole ribbon.** An
  ...
  pull the eye. (On web with a fine pointer, that tip stays hidden until the
  verse is hovered, then click to unfurl; touch keeps the always-on tip.)
  Bookmark it and that tip grows nearly the **full vertical
