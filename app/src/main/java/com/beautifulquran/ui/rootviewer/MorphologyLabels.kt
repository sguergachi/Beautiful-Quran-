...
object MorphologyLabels {
    ...
    private val FEATURE = mapOf(
        ...
        "2MD" to "2nd person masculine dual",
        "2FD" to "2nd person feminine dual",
        ...
        "3MD" to "3rd person masculine dual",
        "3FD" to "3rd person feminine dual",
        "INDEF" to "indefinite",
        "MOOD:JUS" to "jussive mood",
        "MOOD:SUBJ" to "subjunctive mood",
        "(I)" to "form I",
        "(II)" to "form II",
        "(III)" to "form III",
        "(IV)" to "form IV",
